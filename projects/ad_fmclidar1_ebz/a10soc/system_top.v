...
module system_top (
  ...
  system_bd i_system_bd (
    ...
    .sys_spi_clockgen_MISO (spi_miso_s),
    .sys_spi_clockgen_MOSI (spi_mosi_s),
    .sys_spi_clockgen_SCLK (spi_clk),
    .sys_spi_clockgen_SS_n (spi_csn_s),
    // SPI interface for DAQ's VCO
    .sys_spi_vco_MISO (spi_miso_s),
    .sys_spi_vco_MOSI (spi_mosi_s),
    .sys_spi_vco_SCLK (spi_clk),
    .sys_spi_vco_SS_n (spi_csn_s),
    // SPI interface for AFE's DAC chip
    .sys_spi_afe_adc_MISO (spi_miso_s),
    .sys_spi_afe_adc_MOSI (spi_mosi_s),
    .sys_spi_afe_adc_SCLK (spi_clk),
    .sys_spi_afe_adc_SS_n (spi_csn_s),
    // JESD204B for AD9694
